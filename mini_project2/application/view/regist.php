    ...
    <div id="con">
        ...
        <div class="loginBox">
            <form action="/user/regist" method="post">
                <input type="text" placeholder="아이디(5~12글자)" name="id" class="inp" id="id" onkeyup="chkId();" maxlength="12" value=<?php echo $_POST != null? $inpPost["id"] : ""; ?>>
                ...
                <br>
                <input type="text" placeholder="이름(최대 30글자)" name="name" class="inp" id="name" onkeyup="chkName();" maxlength="30" value=<?php echo $_POST != null? $inpPost["name"] : ""; ?>>
