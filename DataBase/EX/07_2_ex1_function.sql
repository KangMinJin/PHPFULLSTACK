...
SELECT CONCAT('안녕하세요.', ' 좋은아침입니다.') AS Hello;
...
-- 	ADDDATE(날짜1, INTERVAL 날짜2) : 날짜1에서 날짜2를 더한 날짜를 구합니다.(음수 사용 가능.)
SELECT ADDDATE(NOW(), INTERVAL -1 DAY);

-- 	SUBDATE(날짜1, INTERVAL 날짜2) : 날짜1에서 날짜2를 뺍 날짜를 구합니다.
SELECT SUBDATE(NOW(), INTERVAL 1 DAY);

-- 	ADDTIME(날짜/시간, 시간) : 날짜/시간에서 시간를 더한 날짜/시간을 구합니다.(음수 사용 가능.)
SELECT ADDTIME(NOW(), '-1:1:1');

-- 	SUBTIME(날짜/시간, 시간) : 날짜/시간에서 시간를 뺍 날짜/시간을 구합니다.
